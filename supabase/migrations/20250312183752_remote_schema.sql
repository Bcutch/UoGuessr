...
CREATE OR REPLACE FUNCTION "public"."get_pictures_by_player"("playerid" "uuid") RETURNS TABLE("picture_id" "uuid", "player_id" "uuid", "storage_url" "text", "longitude" double precision, "latitude" double precision, "title" "text", "created_at" timestamp with time zone)
...
ALTER FUNCTION "public"."get_pictures_by_player"("playerid" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_random_pictures"("count" integer DEFAULT 5) RETURNS TABLE("picture_id" "uuid", "player_id" "uuid", "storage_url" "text", "long" double precision, "lat" double precision, "title" "text", "created_at" timestamp with time zone)
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
    ...
    SELECT 
        ...
        p.player_id, 
        p.storage_url, 
        public.st_x(p.location::public.geometry) as long, 
        public.st_y(p.location::public.geometry) as lat, 
        p.title, 
        p.created_at 
    FROM public.pictures p
    ORDER BY RANDOM()
...
ALTER FUNCTION "public"."get_random_pictures"("count" integer) OWNER TO "postgres";
...
ALTER TABLE "public"."game_instances" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."game_pictures" (
...
ALTER TABLE "public"."game_pictures" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."guesses" (
    "guess_id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "instance_id" "uuid",
    "picture_id" "uuid",
    "guessed_location" "public"."geography"(Point,4326) NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."pictures" (
    "picture_id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "player_id" "uuid",
...
ALTER TABLE ONLY "public"."friendships"
    ADD CONSTRAINT "friendships_player_id_1_player_id_2_key" UNIQUE ("player_id_1", "player_id_2");



ALTER TABLE ONLY "public"."game_instances"
    ADD CONSTRAINT "game_instances_pkey" PRIMARY KEY ("instance_id");



ALTER TABLE ONLY "public"."game_pictures"
    ADD CONSTRAINT "game_pictures_pkey" PRIMARY KEY ("game_id", "picture_id");
...
ALTER TABLE ONLY "public"."guesses"
    ADD CONSTRAINT "guesses_instance_id_picture_id_key" UNIQUE ("instance_id", "picture_id");
...
CREATE INDEX "pictures_location_idx" ON "public"."pictures" USING "gist" ("location");



ALTER TABLE ONLY "public"."friendships"
    ADD CONSTRAINT "friendships_player_id_1_fkey" FOREIGN KEY ("player_id_1") REFERENCES "public"."players"("player_id");



ALTER TABLE ONLY "public"."friendships"
    ADD CONSTRAINT "friendships_player_id_2_fkey" FOREIGN KEY ("player_id_2") REFERENCES "public"."players"("player_id");



ALTER TABLE ONLY "public"."game_instances"
    ADD CONSTRAINT "game_instances_game_id_fkey" FOREIGN KEY ("game_id") REFERENCES "public"."games"("game_id");



ALTER TABLE ONLY "public"."game_instances"
    ADD CONSTRAINT "game_instances_player_id_fkey" FOREIGN KEY ("player_id") REFERENCES "public"."players"("player_id");



ALTER TABLE ONLY "public"."game_pictures"
    ADD CONSTRAINT "game_pictures_game_id_fkey" FOREIGN KEY ("game_id") REFERENCES "public"."games"("game_id");



ALTER TABLE ONLY "public"."game_pictures"
    ADD CONSTRAINT "game_pictures_picture_id_fkey" FOREIGN KEY ("picture_id") REFERENCES "public"."pictures"("picture_id");



ALTER TABLE ONLY "public"."guesses"
    ADD CONSTRAINT "guesses_instance_id_fkey" FOREIGN KEY ("instance_id") REFERENCES "public"."game_instances"("instance_id");



ALTER TABLE ONLY "public"."guesses"
    ADD CONSTRAINT "guesses_picture_id_fkey" FOREIGN KEY ("picture_id") REFERENCES "public"."pictures"("picture_id");



ALTER TABLE ONLY "public"."pictures"
    ADD CONSTRAINT "pictures_player_id_fkey" FOREIGN KEY ("player_id") REFERENCES "public"."players"("player_id");
...
GRANT ALL ON FUNCTION "public"."get_pictures_by_player"("playerid" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_pictures_by_player"("playerid" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_pictures_by_player"("playerid" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_random_pictures"("count" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_random_pictures"("count" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_random_pictures"("count" integer) TO "service_role";
...
GRANT ALL ON TABLE "public"."game_pictures" TO "anon";
GRANT ALL ON TABLE "public"."game_pictures" TO "authenticated";
GRANT ALL ON TABLE "public"."game_pictures" TO "service_role";
